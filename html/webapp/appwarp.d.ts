...
declare module AppWarp {
    ...
    class Zone {
        private name;
        private appKey;
        constructor(_name: string, _appKey: string);
    ...
    class Server {
        private address;
        private appKeys;
        constructor(_address: Address, _appKeys: Zone[]);
...
declare module AppWarp {
    class WarpClient {
        ...
        private recovering;
        constructor();
        static initialize(API_KEY: string, server: string, port: string, enableSSL: boolean): void;
