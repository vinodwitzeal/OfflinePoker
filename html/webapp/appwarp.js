...
(function (AppWarp) {
    var AllServerEvent = (function () {
        function AllServerEvent(_result, payload) {
            ...
            for (var i in json) {
                var addr = new AppWarp.Address(json[i].address.host, json[i].address.port);
...
(function (AppWarp) {
    var WarpClient = (function () {
        ...
        WarpClient.prototype.startGame = function () {
            var data = AppWarp.RequestBuilder.buildWarpRequest(this.SessionID, AppWarp.RequestType.StartGame, "", true);
            this.sendMessage(data.buffer);
        };
