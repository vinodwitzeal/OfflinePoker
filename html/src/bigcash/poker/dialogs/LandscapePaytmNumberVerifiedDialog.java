...
public class LandscapePaytmNumberVerifiedDialog extends UIDialog {
    ...
    public LandscapePaytmNumberVerifiedDialog(UIScreen modelScreen, boolean isproceed, String mobileNo, GdxListener<String> listener) {
        super(modelScreen);
