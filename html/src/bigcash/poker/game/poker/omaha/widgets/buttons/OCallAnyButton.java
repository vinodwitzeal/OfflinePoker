...
public class OCallAnyButton extends OmahaButton {
    ...
    public OCallAnyButton(final OmahaWorld omahaWorld, int id, Label.LabelStyle labelStyle, TextureRegionDrawable uncheckedDrawable, TextureRegionDrawable checkedDrawable) {
