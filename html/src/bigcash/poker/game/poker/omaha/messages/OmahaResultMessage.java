...
public class OmahaResultMessage {
    ...
    public OmahaResultMessage(OmahaWorld pokerWorld, JsonValue jsonValue) {
        ...
        while (playersArrayIterator.hasNext()) {
            ...
            if (pokerResultPlayer.refundAmount>0) {
                OmahaPlayer pokerPlayer = pokerWorld.getPlayer(pokerResultPlayer.id);
                if (pokerPlayer != null) {
                    pokerPlayer.addBalanceAmount(pokerResultPlayer.refundAmount);
                    pokerPlayer.updateBalanceAmount();
                }
            }
            pokerResultPlayer.updateData(pokerWorld.getPlayer(pokerResultPlayer.id));
    ...
    public class PokerResultPlayer {
        ...
        public void updateData(OmahaPlayer pokerPlayer) {
            PokerPlayerData playerData = null;
            if (pokerPlayer != null) {
                playerData = pokerPlayer.getPlayerData();
            }
            if (playerData != null) {
