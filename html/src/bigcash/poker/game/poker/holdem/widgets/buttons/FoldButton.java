...
public class FoldButton extends GameButton {
    ...
    public FoldButton(final HoldemWorld holdemWorld, int id, Label.LabelStyle labelStyle, TextureRegionDrawable uncheckedDrawable, TextureRegionDrawable checkedDrawable) {
        setName("FoldButton");
       ...
       setState(NO_ACTION);
        ...
        NinePatchDrawable background = new NinePatchDrawable(new NinePatch(holdemWorld.atlas.findRegion("btn_fold"), 13, 13, 10, 15));
