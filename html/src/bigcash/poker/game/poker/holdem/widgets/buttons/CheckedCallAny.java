...
public class CheckedCallAny extends GameButton {
    ...
    public CheckedCallAny(final HoldemWorld holdemWorld, int id, Label.LabelStyle labelStyle, TextureRegionDrawable uncheckedDrawable, TextureRegionDrawable checkedDrawable) {
