...
public class OCallButton extends OmahaButton {
    ...
    public OCallButton(final OmahaWorld omahaWorld, int id, Label.LabelStyle labelStyle, TextureRegionDrawable uncheckedDrawable, TextureRegionDrawable checkedDrawable) {
        setName("CallButton");
        ...
        NinePatchDrawable background = new NinePatchDrawable(new NinePatch(omahaWorld.atlas.findRegion("btn_call"), 13, 13, 10, 15));
            ...
            public void clicked(InputEvent event, float x, float y) {
                switch (getState()) {
                    ...
                    case CHECKED:
                        ...
                        break;
                    case CALL:
                        omahaWorld.screen.sendMove(PokerConstants.MOVE_CALL,getAmount());
                        break;
                }
            }
        });
